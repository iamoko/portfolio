...
function Nav() {
  ...
  const icon_class = `text-xl text-gray-100 group-hover:text-orange-400 transform transition duration-300`;
  const menu = [
    {
      icon: (
        <AiOutlineUser
  ...
  return (
    <div>
      <div className="px-4 pt-6 pb-0.5 rounded-sm main mt-4">
        {_.map(menu, (m, i) => (
